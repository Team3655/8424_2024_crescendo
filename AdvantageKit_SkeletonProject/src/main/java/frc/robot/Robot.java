...
public class Robot extends LoggedRobot {
  ...
  private static final String LeftSideRed = "LeftSideRed";
  private static final String LeftSideBlue = "LeftSideBlue";
  ...
  private final AHRS gyro =
      new AHRS(
          edu.wpi.first.wpilibj.SerialPort.Port.kMXP, SerialDataType.kProcessedData, (byte) 50);

  private final DifferentialDriveKinematics kinematics =
      new DifferentialDriveKinematics(Units.inchesToMeters(20.5));
  ...
  public void robotInit() {
    ...
    m_chooser.addOption("LeftsideRed", LeftSideRed);
    m_chooser.addOption("LeftsideBlue", LeftSideBlue);
  ...
  public void robotPeriodic() {
    ...
    DifferentialDriveWheelPositions wheelPositions =
        new DifferentialDriveWheelPositions(
            leftEncoder1.getPosition(), rightEncoder1.getPosition());
  ...
  public void autonomousPeriodic() {
    switch (m_autoSelected) {
      ...
      case speaker:
        ...
        } else if (timer.get() < 10.5) { // 1 sec

          pullMotor.set(-.5);

          // Feed the note

        } else if (timer.get() < 12.5) { // 1.5 sec
      ...
      case blue_amp:
        ...
        // rotateMotor
        // .getPIDController()
        // .setReference(-210, ControlType.kPosition);
